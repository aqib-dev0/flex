...
let PropertiesController = class PropertiesController {
    ...
    async getAllProperties() {
        try {
            ...
            throw new common_1.HttpException(error || 'Failed to fetch properties', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async getPropertyById(id) {
        try {
            ...
            throw new common_1.HttpException(error || 'Failed to fetch property', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
};
